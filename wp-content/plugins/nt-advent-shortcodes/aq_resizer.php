...
if(!class_exists('Nt_Advent_Aq_Resize')) {
    class Aq_Exception extends Exception {}

    class Nt_Advent_Aq_Resize {
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                error_log('Nt_Advent_Aq_Resize.process() error: ' . $ex->getMessage());
...
if(!function_exists('nt_advent_aq_resize')) {
    function nt_advent_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        $nt_advent_aq_resize = Nt_Advent_Aq_Resize::getInstance();
        return $nt_advent_aq_resize->process( $url, $width, $height, $crop, $single, $upscale );
    }
}