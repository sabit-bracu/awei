 ...
 *
 * @package   Gamajo_Price_Single_Entry_Term_Body_Classes
 * @author    Gary Jones
 * @license   GPL-2.0+
 ...
 * @author  Gary Jones
 */
class Gamajo_Price_Single_Entry_Term_Body_Classes {
	...
	public function body_class( $classes ) {
		...
		global $price_post_type_registrations;
		return array_merge( $classes, $this->get_taxonomy_term_classes( $price_post_type_registrations->taxonomies ) );
	}
